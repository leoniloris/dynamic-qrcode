defmodule DynQrcode.QrCodesTest do
  ...
  describe "qrcode" do
    ...
    @valid_attrs %{base_url: "some base_url", is_valid: true, target_url: "some target_url"}
    ...
    test "create_qr_code/1 with valid data creates a qr_code" do
      ...
      assert qr_code.target_url == "some target_url"
    end
    ...
    test "update_qr_code/2 with valid data updates the qr_code" do
      ...
      assert qr_code.target_url == "some updated target_url"
    end
